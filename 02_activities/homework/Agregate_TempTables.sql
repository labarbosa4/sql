...
SELECT vendor_id , count (*) AS booth_rented_count
FROM vendor_booth_assignments
GROUP BY vendor_id
ORDER	BY booth_rented_count DESC;
...
-- Create temporary table named ne
...
-- Code to insert a 10th row in the temporary vendor table 'new_vendor'

INSERT INTO new_vendor (vendor_id, vendor_name, vendor_type, vendor_owner_first_name, vendor_owner_last_name)
VALUES (10, 'Thomass Superfood Store', 'Fresh Focused', 'Thomas', 'Rosenthal');


-- Test for the new temporary table values, now the result shows 10 vendors. 
